...
function AdvancedPartners() {
    ...
    ar: [
      {
        ...
        category: 'شركة أدوية عالمية',
        specialization: 'الأدوية المتقدمة والابتكار',
        description: 'Novax هي شركة عالمية متخصصة في تطوير وإنتاج الأدوية عالية الجودة. تركز الشركة على الابتكار وتوفير حلول علاجية فعالة لعدد واسع من الأمراض. شراكتنا معها تُعزز قدراتنا في تزويد السوق المحلي بأحدث المنتجات الطبية المستندة إلى أحدث التقنيات والمعايير العالمية.',
        highlights: [
          'أدوية عالية الجودة',
          'حلول علاجية مبتكرة',
          'معايير عالمية',
      ...
      },
      {
        ...
        category: 'شركة أدوية رائدة',
        specialization: 'المنتجات الدوائية المعتمدة',
        description: 'Dan Pharm هي شركة أدوية رائدة تتميز بمجموعة واسعة من المنتجات الدوائية المعتمدة. تهدف إلى تحسين الصحة العامة من خلال توفير أدوية فعالة وآمنة. الشراكة معها تُمكّننا من توسيع نطاق المنتجات المتوفرة في السوق الفلسطيني وتعزيز خيارات العلاج المتاحة للمرضى.',
        highlights: [
          'منتجات معتمدة',
          'أدوية فعالة وآمنة',
          'تحسين الصحة العامة',
 ...
 category: 'شركة رائدة في توزيع الأدوية',
specialization: 'تجارة وتوزيع المستحضرات الصيدلانية',

  description: 'U&ME هي شركة رائدة في تجارة وتوزيع الأدوية داخل قطاع غزة، تتميز بتقديم خدمات متميزة للقطاع الطبي وتسهم بشكل فعال في تلبية احتياجات السوق المحلية من الأدوية والمستلزمات الطبية. شراكتنا مع الشركة منذ عام 2023 تهدف إلى تعزيز توفر الأدوية وتحسين جودة الخدمات الصحية المقدمة في غزة.',
  highlights: [
    'توزيع معتمد للأدوية',
